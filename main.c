                    ...
                    for(l=0;l<6;l++)
                    {
                        ...
                        if(m.mat[l][position]=='x' || m.mat[l][position]=='o')
                        {
                            ...
                            {  
                                ...
                                gotoxy(8,23);/*printf("cesr%c",m.mat[0][position]);*/
                            }
                        }
                    }
                }   
...
int verif_gain(char symbole , int position)
{
   ...
   for(l=0;l<6;l++)
   {
        if(m.mat[l][position]==symbole)
        {
            ...
            {
                gotoxy(8,27);printf("Victoire sur la Verticale de %s " , jou1.joueur);
                return 1 ;
                break;
            }
            if(compt==4 && jou2.symbole==symbole)
            {gotoxy(8,27);printf("Victoire sur la Verticale de %s " , jou2.joueur);
                return 1;
                break;
            }
    }
        ...
        for(c=0;c<7;c++)
        {
            if(m.mat[l][c]==symbole )
            {
                ...
                if(m.mat[l][c]!=symbole)
                {
                    ...
                    if(compt>=4 && jou1.symbole==symbole)
                    {
                        gotoxy(8,27);printf("Victoire sur l'Horizontale de %s " , jou1.joueur);
                        return 1;
                        break;
                    }
                    if(compt>=4 && jou2.symbole==symbole)
                    {gotoxy(8,27);printf("Victoire sur l'Horizontale de %s " , jou2.joueur);
                        return 1;
                        break;
                    }
        }
    ...
    for(l=0;l<6;l++)
    {
        if(m.mat[l][position]==symbole)
        {
            ...
            c=position;
            gotoxy(8,22);
            if(m.mat[p-1][position+1]==symbole)
            {
                compt++;
                if(p-1<0 || position+1 >6)
                {
                    compt=0;
                }
            } break;
    ...
    for(l=p;l<6;l++)
    {
        ...
        if(compt>=4 && jou1.symbole==symbole)
        {
            gotoxy(8,27);printf("Victoire sur la Diagonale Gauche Vers le Bas de %s " , jou1.joueur);
            return 1;
            break;
        }
        if(compt>=4 && jou2.symbole==symbole)
        {
            gotoxy(8,27);printf("Victoire sur la Diagonale Gauche vers le Bas de %s " , jou2.joueur);
            return 1;
            break;
        }
    }
    ...
    for(l=0;l<6;l++)
    {
        if(m.mat[l][position]==symbole)
        {
            p=l;c=position;gotoxy(8,22);  
            if(m.mat[p-1][position-1]==symbole)
            {
                compt++;
                if(p-1<0 || position-1<0)
                {
                    compt=0;
                }
            } break;
    ...
    for(l=p;l<6;l++)
    {
        ...
        if(compt>=4 && jou1.symbole==symbole)
        {
            gotoxy(8,27);printf("Victoire sur la Diagonale Droite Vers le Bas de %s " , jou1.joueur);
            return 1;
            break;
        } 
        if(compt>=4 && jou2.symbole==symbole)
        {
            gotoxy(8,27);printf("Victoire sur la Diagonale Droite Vers le Bas de %s " , jou2.joueur);
            return 1;
            break;
        }
    }
    ...
    for(l=p;l>=0;l--)
    {
        ...
        if(compt>=4 && jou1.symbole==symbole)
        {
            gotoxy(8,27);printf("Victoire sur la Diagonale Droite Vers le Haut de %s " , jou1.joueur);
            return 1; 
            break;
        }
        if(compt>=4 && jou2.symbole==symbole)
        {
            gotoxy(8,27);printf("Victoire sur la Diagonale Droite Vers le Haut  de %s " , jou2.joueur);
            return 1;
            break;
        }
    }
    ...
    for(l=p;l>=0;l--)
    {
        ...
        if(compt>=4 && jou1.symbole==symbole)
        {
            gotoxy(8,27);printf("Victoire sur la Diagonale Gauche Vers le Haut de %s " , jou1.joueur);
            return 1;
            break;
        }
        if(compt>=4 && jou2.symbole==symbole)
        {
            gotoxy(8,27);printf("Victoire sur la Diagonale Gauche Vers le Haut de %s " , jou2.joueur);
            return 1 ;
            break;
        }
    }
    ...
    for(c=0;c<7;c++)
    {
        ...
        if(compt==7)
        {
            gotoxy(8,27);printf("Matche Null entre %s et %s " , jou1.joueur , jou2.joueur);
            return 1;
        }
    }
return 0;
...
do
{
    if(random==1)
    {
        ...
        gotoxy(8,25);printf("%s choisi ton symbole (x/o):", jou1.joueur);
        taille = strlen(jou1.joueur);
        gotoxy(37+taille,25);scanf(" %c", &jou1.symbole);
    } else
    {
        gotoxy(8,24);printf("C'est  %s qui commence.", jou2.joueur);
        gotoxy(8,25);printf("%s choisi ton symbole (x/o):", jou2.joueur);
        taille = strlen(jou2.joueur);
    ...
    do
    {
        ...
        {
            Color(7,0); 
            gotoxy(80,17);printf("C'est  %s qui joue.", jou1.joueur);
            do
            {
                gotoxy(8,27);printf(" %s Entre une position valide:", jou1.joueur); 
                gotoxy(38+taille,27);scanf("%d", &position1);    
                while(getchar() != '\n');
               if(position1>6)
                {
                    gotoxy(80,27);printf("  %s %d est une position invalide", jou1.joueur ,position1); 
                }
                    if(m.mat[0][position1]=='x' ||  m.mat[0][position1]=='o')
                    {
                        gotoxy(80,25);printf(" La collonne  %d est pleine ", position1);  
                    }
        ...
        {
            Color(7,0); 
            gotoxy(80,17);printf("C'est  %s qui joue.", jou2.joueur);
            do
            { 
                gotoxy(8,27);printf(" %s Entre une position valide:", jou2.joueur); 
                gotoxy(38+taille,27);scanf("%d", &position2);   
                while(getchar() != '\n');
                if(position2>6)
                {
                    gotoxy(80,28);printf("  %s %d est une position invalide", jou2.joueur ,position2); 
                }
                    if(m.mat[0][position2]=='x' ||  m.mat[0][position2]=='o')
                    {
                        gotoxy(80,25);printf(" La collonne  %d est pleine ", position2);  
                    }
